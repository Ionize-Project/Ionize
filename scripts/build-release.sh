...
function usage()
{
    ...
    echo "and generates the checksum files of the Ionize tag provided."
    echo
...
# -- Config
GITHUB_REPO="https://github.com/Ionize/Ionize.git"
CLONE_DIR="$BUILD_DIRECTORY/Ionize-buildall"
TARGET_DIR="$BUILD_DIRECTORY/Ionize-releases"
DYNAMIC_RELEASE="Ionize-${TAG_VERSION}-linux-CLI"
STATIC_RELEASE="Ionize-${TAG_VERSION}-linux-staticboost-CLI"
